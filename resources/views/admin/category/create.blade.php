<!--- Modal Ajout -->
<div class="modal fade" id="btnAddCategory" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel"
            ...
            <form method="POST"  id='category_form' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-primary" type="submit" id="btn-add">Okay</button>
