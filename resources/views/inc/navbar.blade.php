            ...
            <div class="row">
                <div class="col-lg-7 col-md-5 col-xs-12">
                    ...
                    <ul class="list-inline">
                        ...
                        <li><i class="lni-envelope"></i> <a
                                ...
                                data-cfemail="9ae9efeaeaf5e8eedafdf7fbf3f6b4f9f5f7">[email&#160;protected]</a></li>
                    </ul>
                ...
                <div class="col-lg-5 col-md-7 col-xs-12">
                    ...
                    <div class="header-top-right float-right">
                        ...
                        <a href="/user/register" class="header-top-button"><i class="lni-pencil"></i> Register</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a href="index-2.html" class="navbar-brand"><img src="{{asset('mainassets/img/logo.png')}}" alt=""></a>
            </div>
