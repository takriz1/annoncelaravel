                                ...
                                <table class="table table-responsive dashboardtable tablemyads">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-category="active">
                                            ...
                                            <td data-title="Category"><span class="adcategories">{{$p->category->libelle_c}}</span>
                                            </td>
                                            ...
                                            <td data-title="Action">
                                                <div class="btns-actions">
                                                    <a class="btn-action btn-view" href="#"><i
                                                            ...
                                                            <a type="button" class="btn-action btn-edit" data-toggle="modal" data-target="#editProduct{{$p->id}}">
                                                                <i class="lni-pencil"></i>
                                                              </a>
                                                    <a class="btn-action btn-delete" href="/user/product/{{$p->id}}/destroy"><i
                                                            class="lni-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
  ...
  <div class="modal fade" id="editProduct{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="/user/product/edit" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="modal-body">
            <div class="mb-3">
                <label class="form-label" for="exampleFormControlInput1">Product Name : <span class="text-primary">{{ $p->name }}</span></label>
                <input class="form-control form-control" id="sizingInput" type="text" placeholder="Category name" name="name" value="{{$p->name}}">
                @error('name')
            ...
            @enderror
              ...
              <div class="mb-0">
                <label class="form-label" for="exampleTextarea">Product Description </label>
                <textarea class="form-control" id="exampleTextarea" rows="3" name="desc">{{ $p->description }}</textarea>
                @error('desc')
                <div class="alert alert-danger">
                    {{ $message }}
            ...
            @enderror
              ...
              <div class="mb-3">
                <label class="form-label" for="exampleFormControlInput1">Price : <span class="text-primary">{{ $p->price }}</span></label>
                <input class="form-control form-control" id="sizingInput" type="number" placeholder="Product price" name="price" value="{{$p->price}}">
                @error('price')
                <div class="alert alert-danger">
                    {{ $message }}
            ...
            @enderror
              ...
              <div class="mb-3">
                <label class="form-label" for="exampleFormControlInput1">Quantity : <span class="text-primary">{{ $p->qtt }}</span></label>
                <input class="form-control form-control" id="sizingInput" type="number" placeholder="Product Quantity" name="qtt" value="{{$p->qtt}}">
                @error('qtt')
                <div class="alert alert-danger">
                    {{ $message }}
